...
ignore_elements: List[Tuple[str, str]] = [
    ...
    ("sdk/glycin.bst", "Recent glycin hangs GDM. We need to investigate."),
    ("sdk/libglycin-gtk4.bst", "Recent glycin hangs GDM. We need to investigate."),
    ("sdk/libglycin.bst", "Recent glycin hangs GDM. We need to investigate."),
]
