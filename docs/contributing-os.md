...
First, open a workspace for the component you want to work on as described in [Making changes](./contributing.md#4-making-changes). Then, each time you want to build a system extension with your changes, run the following:
...
First, open a workspace for the component you want to work on as described in [Making changes](./contributing.md#4-making-changes). Then, each time you want to build a `systemd-sysupdate` image with your changes and serve it from a local repository, run the following:
